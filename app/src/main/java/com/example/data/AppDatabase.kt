...
@Database(entities = [Topic::class, TestMark::class, Flashcard::class], version = 5, exportSchema = false)
    ...
    companion object {
        val MIGRATION_4_5 = object : Migration(4, 5) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE flashcards ADD COLUMN chapter TEXT NOT NULL DEFAULT 'General'")
            }
        }
